        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                    ...
                    @if (Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage logged history'))
                        <li
                            ...
                            <a href="#!" class="pc-link">
                                ...
                                <span class="pc-mtext">{{ __('Team') }}</span>
               ...
               <!-- @if (Gate::check('manage visitor') ||
                        Gate::check('manage today visitor') ||
                    ...
                    @if (Gate::check('manage visitor'))
                        <li class="pc-item {{ in_array($routeName, ['visitor.index']) ? 'active' : '' }}">
                            <a href="{{ route('visitor.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="ti ti-anchor"></i></span>
                                <span class="pc-mtext">{{ __('All Visitor') }}</span>
                            </a>
                        </li>
                    @endif
                    @if (Gate::check('manage pre register visitor') && $subscription->enabled_pre_register == 1)
                        <li class="pc-item {{ in_array($routeName, ['visitor.pre-register']) ? 'active' : '' }}">
                            <a href="{{ route('visitor.pre-register') }}" class="pc-link">
                                <span class="pc-micon"><i class="ti ti-user-plus"></i></span>
                                <span class="pc-mtext">{{ __('Pre Register') }}</span>
                            </a>
                        </li>
                    @endif
                    @if (Gate::check('manage today visitor'))
                        <li class="pc-item {{ in_array($routeName, ['visitor.today']) ? 'active' : '' }}">
                            <a href="{{ route('visitor.today') }}" class="pc-link">
                                <span class="pc-micon"><i class="ti ti-user-check"></i></span>
                                <span class="pc-mtext">{{ __('Today Visitor') }}</span>
                            </a>
                        </li>
                    @endif
                ...
                @endif-->
                    ...
                    <li class="pc-item {{ in_array($routeName, ['visitor.pre-register']) ? 'active' : '' }}">
                            <a href="{{ route('videos.create') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-solid fa-video"></i></span>
                                <span class="pc-mtext">{{ __('New Video') }}</span>
                            </a>
                        </li>

                      <li class="pc-item {{ in_array($routeName, ['visitor.pre-register']) ? 'active' : '' }}">
                            <a href="{{ route('ai_studio.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-solid fa-gamepad"></i></span>
                                <span class="pc-mtext">{{ __('AI Studio') }}</span>
                            </a>
                        </li>
                    <li class="pc-item {{ in_array($routeName, ['visitor.pre-register']) ? 'active' : '' }}">
                            <a href="{{ route('studio.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-solid fa-gamepad"></i></span>
                    ...
                    <li class="pc-item pc-caption">
                        ...
                        <li class="pc-item {{ in_array($routeName, ['visitor.index']) ? 'active' : '' }}">
                            <a href="{{ route('file_manager.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-solid fa-cloud-arrow-up"></i></span>
                                <span class="pc-mtext">{{ __('File Manager') }}</span>
                            </a>
                        </li>
                        <li class="pc-item {{ in_array($routeName, ['visitor.index']) ? 'active' : '' }}">
                            <a href="{{ route('avatar.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-solid fa-user-injured"></i></span>
                                <span class="pc-mtext">{{ __('Avatar') }}</span>
                            </a>
                        </li>
                        <li class="pc-item {{ in_array($routeName, ['visitor.index']) ? 'active' : '' }}">
                            <a href="{{ route('voices.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-solid fa-microphone"></i></span>
                                <span class="pc-mtext">{{ __('Voices') }}</span>
                            </a>
                        </li>
                        <li class="pc-item {{ in_array($routeName, ['visitor.index']) ? 'active' : '' }}">
                            <a href="{{ route('text_to_speech.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-regular fa-keyboard"></i></span>
                                <span class="pc-mtext">{{ __('Text to Speech') }}</span>
                            </a>
                        </li>
                        <li class="pc-item {{ in_array($routeName, ['visitor.index']) ? 'active' : '' }}">
                            <a href="{{ route('file_manager.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-brands fa-youtube"></i></span>
                                <span class="pc-mtext">{{ __('Templates') }}</span>
                            </a>
                        </li>
                        <li class="pc-item {{ in_array($routeName, ['visitor.index']) ? 'active' : '' }}">
                            <a href="{{ route('file_manager.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="fa-solid fa-swatchbook"></i></span>
                                <span class="pc-mtext">{{ __('Branding') }}</span>
                            </a>
                        </li>
              ...
              <!--  @if (Gate::check('manage visit category') || Gate::check('manage notification'))
                    <li class="pc-item pc-caption">
                        <label>{{ __('System Configuration') }}</label>
                        <i class="ti ti-chart-arcs"></i>
                    </li>
                    @if (Gate::check('manage visit category'))
                        <li class="pc-item {{ in_array($routeName, ['visit-category.index']) ? 'active' : '' }} ">
                            <a href="{{ route('visit-category.index') }}" class="pc-link">
                                <span class="pc-micon"><i class="ti ti-layers-subtract"></i></span>
                                <span class="pc-mtext">{{ __('Visit Category') }}</span>
                            </a>
                        </li>
                    @endif
